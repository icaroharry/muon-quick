...
===========================================================================*/
    ...
    var saveLinkToPocket = function(tab, options) {
        ...
        var experiment = PKT_EXT.EXPERIMENT_RUNNER.checkForExperiment('saveLinkToPocket', tab)
        if (experiment.shouldRun) {
            return experiment.runExperiment(url);
        }
        //////////////////////////
...
===========================================================================*/
    ...
    addMessageListener(function messageListenerCallback(request, sender, sendResponse) {
        ...
        switch(request.action){
            ...
            case "experiment":
                return PKT_EXT.EXPERIMENT_RUNNER.messageHandler(request, sender.tab, sendResponse, featureSet)
                break;
